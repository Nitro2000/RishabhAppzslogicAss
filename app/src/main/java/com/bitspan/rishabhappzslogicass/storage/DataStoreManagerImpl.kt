package com.bitspan.rishabhappzslogicass.storage
...
class DataStoreManagerImpl(private val context: Context) : DataStoreManager {
    ...
    private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "appzlogic_datastore")

    companion object {
        val exitCount = intPreferencesKey("exit_count")
    }
